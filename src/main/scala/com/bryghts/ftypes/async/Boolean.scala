 ...
 */
class Boolean private(val future: Future[scala.Boolean])(override implicit protected val executionContext: ExecutionContext) extends async.Any[scala.Boolean, async.Boolean]
{
